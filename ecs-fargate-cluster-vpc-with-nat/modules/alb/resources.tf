resource "aws_lb" "tfer--dev-cluster-alb" {
  ...
  subnets = ["${data.terraform_remote_state.subnet.outputs.aws_subnet_tfer--subnet-0141cfa4c3a5f4896_id}", "${data.terraform_remote_state.subnet.outputs.aws_subnet_tfer--subnet-0a6d91f87b68a4d68_id}"]
